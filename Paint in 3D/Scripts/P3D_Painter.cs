...
public class P3D_Painter
{
	...
	private static P3D_Painter tempInstance;

	public static P3D_Painter TempInstance
	{
		get
		{
			if (tempInstance == null)
			{
				tempInstance = new P3D_Painter();
			}
	...
	public bool IsReady
	{
		get
		{
			return Canvas != null && Tiling.x != 0.0f && Tiling.y != 0.0f;
		}
	}
